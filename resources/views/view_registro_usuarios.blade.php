                        ...
                        <form method="POST" action="{{ route('usuario.store') }}" id="form_registro">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div id="texto_name" class="form-control-feedback text-danger d-none">Nombre no
                                        válido
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div id="texto_apellido_p" class="form-control-feedback text-danger d-none">Apellido
                                        no válido
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div id="texto_apellido_s" class="form-control-feedback text-danger d-none">Apellido
                                        no válido
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div id="texto_email" class="form-control-feedback text-danger d-none">Email no
                                        válido
                                    </div>
                                </div>
                            </div>
